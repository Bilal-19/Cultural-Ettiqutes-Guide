    ...
    return (
        <>
            ...
            <div class="w-full bg-[url('/home.png')] bg-no-repeat bg-center h-100 md:h-150 flex justify-center">
                <h2 className="font-medium text-4xl md:text-6xl pt-5 md:pt-10">
                    Travel Respectfully.
                    <br />
                ...
                {blogRecords.map((val, key) =>
                    <>
                        <div className="mx-auto">
                            <img src={val.thumbnailPath} alt="" />
                            <p className="text-lg">{val.blogTitle}</p>
            ...
            <div className="container mx-auto grid grid-cols-2 md:grid-cols-5 gap-10 pb-15 md:pb-30">
                {countryRecords.map((val, key) =>
                    <>
                        <div className="mx-auto">
                            <img src={val.flagImage} alt={val.countryName} className="mb-3" />
                            <p className="text-md">{val.countryName}</p>
                        </div>
                    </>
                )}
            </div>
